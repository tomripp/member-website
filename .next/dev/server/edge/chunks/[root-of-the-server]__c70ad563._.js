(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["chunks/[root-of-the-server]__c70ad563._.js",
...
const JWT_SECRET_KEY = ()=>new TextEncoder().encode(process.env.JWT_SECRET ?? "fallback-secret-change-me");
async function middleware(request) {
    ...
    if (PROTECTED_PATHS.test(pathname)) {
        ...
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$jose$2f$dist$2f$webapi$2f$jwt$2f$verify$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["jwtVerify"])(sessionCookie.value, JWT_SECRET_KEY());
        } catch  {
            const locale = pathname.split("/")[1] || "en";
            const loginUrl = new URL(`/${locale}/auth/login`, request.url);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c70ad563._.js.map